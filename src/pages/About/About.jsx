  ...
  return (
    <section id="about">
      <h1 className="about-heading">
        Experience the Magic of Zanzibar with <b> Utulivu Tours</b>
      </h1>
      ...
      <p className="about-heading__description">
        ...
        breathtaking island of Zanzibar.
      </p>
      <p className="about-heading__description">
        ...
        Utulivu Tours has the perfect itinerary tailored just for you.
      </p>
      <p className="about-heading__description">
        ...
        unique stories of Zanzibar, ensuring that every tour is both educational
        and enjoyable.
      </p>
    </section>
  );
